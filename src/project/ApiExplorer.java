...
public class ApiExplorer {
	...
	public ApiExplorer() throws IOException{
        ...
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=RwZtrw9P2LkwOjwSKlAiAA5kFoiMaiHxPgak2hv2eXKWdKnlkSdwIDXnyHpgnyp41iRPZx%2BHi%2BtQ2qYlZATwVw%3D%3D"); /*Service Key*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("base_date","UTF-8") + "=" + URLEncoder.encode(time, "UTF-8")); /*조회 날짜. 2020년 11월 24일*/
